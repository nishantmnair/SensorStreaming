...
android {
  namespace = "com.meta.spatial.samples.sensorstreaming"
  //noinspection GradleDependency
  compileSdk = 34

  defaultConfig {
    applicationId = "com.meta.spatial.samples.sensorstreaming"
    minSdk = 34
...
spatial {
  ...
  scenes {
    hotReload {
      appPackage.set("com.meta.spatial.samples.sensorstreaming")
      appMainActivity.set(".SensorStreamingActivity")
